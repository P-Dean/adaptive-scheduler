...
static const DanaTypeField function_hostLib_clone_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_hostLib_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_hostLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_hostLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_hostLib_getcores_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_hostLib_getmemory_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_hostLib_getglobalmemory_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaType object_hostLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_hostLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 24, (DanaTypeField*) &function_hostLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_hostLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_hostLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_hostLib_getcores_fields, 1},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_hostLib_getmemory_fields, 1},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_hostLib_getglobalmemory_fields, 1}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_hostLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_hostLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_hostLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_hostLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_hostLib_functions_spec[4], "getcores", 8},
{(DanaType*) &object_hostLib_functions_spec[5], "getmemory", 9},
{(DanaType*) &object_hostLib_functions_spec[6], "getglobalmemory", 15}};
static const DanaType object_hostLib_events_spec[] = {
};
static const DanaTypeField intf_events_def[] = {
};
static const DanaType hostLib_object_spec[] = {
...
{(DanaType*) &hostLib_object_spec[0], ".functions", 10},
{(DanaType*) &hostLib_object_spec[1], ".events", 7},
{(DanaType*) &hostLib_object_spec[2], ".state", 6},
};
...
static unsigned char op_getcores_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
static unsigned char op_getmemory_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
static unsigned char op_getglobalmemory_thread_spec[sizeof(VFrameHeader)+sizeof(VFrame)];
...
(size_t) op_getcores_thread_spec,
(size_t) op_getmemory_thread_spec,
(size_t) op_getglobalmemory_thread_spec};
static DanaType libType = {TYPE_OBJECT, 0, 0, (DanaTypeField*) intf_def, 3};
static InterfaceDetails ids[] = {{"hostLib", 7, &libType}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[3];
((VFrameHeader*) op_getID_thread_spec) -> functionName = "getID";
((VFrameHeader*) op_getcores_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_getcores_thread_spec) -> formalParamsCount = 0;
((VFrameHeader*) op_getcores_thread_spec) -> sub = NULL;
((VFrameHeader*) op_getcores_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[4];
((VFrameHeader*) op_getcores_thread_spec) -> functionName = "getcores";
((VFrameHeader*) op_getmemory_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_getmemory_thread_spec) -> formalParamsCount = 0;
((VFrameHeader*) op_getmemory_thread_spec) -> sub = NULL;
((VFrameHeader*) op_getmemory_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[5];
((VFrameHeader*) op_getmemory_thread_spec) -> functionName = "getmemory";
((VFrameHeader*) op_getglobalmemory_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 8;
((VFrameHeader*) op_getglobalmemory_thread_spec) -> formalParamsCount = 0;
((VFrameHeader*) op_getglobalmemory_thread_spec) -> sub = NULL;
((VFrameHeader*) op_getglobalmemory_thread_spec) -> localsDef = (size_t) &object_hostLib_functions_spec[6];
((VFrameHeader*) op_getglobalmemory_thread_spec) -> functionName = "getglobalmemory";
...
{"getcores", (VFrameHeader*) op_getcores_thread_spec},
{"getmemory", (VFrameHeader*) op_getmemory_thread_spec},
{"getglobalmemory", (VFrameHeader*) op_getglobalmemory_thread_spec}};
